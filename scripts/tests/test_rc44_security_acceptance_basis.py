...
class RC44SecurityAcceptanceBasisTests(unittest.TestCase):
    def test_manifest_retired_metric_and_unique_lanes(self) -> None:
        ...
        self.assertEqual(data["acceptance_basis_revision"], 3)
        self.assertEqual(data["supersession"]["previous_acceptance_basis"], "POST-I5")
        self.assertEqual(data["supersession"]["previous_manifest_sha256"], "439ff97be38b52a7c5ac05de19ae8167d20d38660fd9b5815feee80e13647840")
        self.assertEqual(data["supersession"]["current_acceptance_basis"], "POST-R5")
        self.assertEqual(data["supersession"]["reason"], "20 permanent R5 signed-package temporal-authority regressions")
        ...
        self.assertTrue(set(by_id) >= {"i4_r4", "i5_i2b", "r5", "p0c3e1", "oracle_attester", "rfc8785", "resolver_v2", "rust_frozen_layout"})
        ...
        self.assertEqual(by_id["oracle_attester"]["expected_passed"], 1320)
        self.assertEqual(by_id["oracle_attester"]["expected_skipped"], 3)
        self.assertEqual(data["supersession"]["lane_reconciliations"]["p0c3e1"], {"previous_passed": 295, "current_passed": 315, "delta_passed": 20})
        self.assertEqual(data["supersession"]["lane_reconciliations"]["oracle_attester"], {"previous_passed": 1300, "current_passed": 1320, "delta_passed": 20, "previous_skipped": 3, "current_skipped": 3, "delta_skipped": 0})
